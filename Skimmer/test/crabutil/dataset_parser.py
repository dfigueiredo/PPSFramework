        ...
        for samples in samples_node:
            ...
            for dataset in dataset_node:
                ...
                try:
                        ...
                        json = dataset.getElementsByTagName("json")[0]
                        tier = dataset.getElementsByTagName("tier")[0]
                        ...
                        command.append([str(samplename.firstChild.data), str(typemode.firstChild.data), str(era.firstChild.data), str(year.firstChild.data), str(json.firstChild.data), str(tier.firstChild.data), str(configfile.firstChild.data), str(nevents.firstChild.data),str(tag.firstChild.data), str(enable.firstChild.data), str(outLFNDirBase.firstChild.data)])
                        ...
                        if verbose:
                           ...
                           print(color.OKBLUE + "\tJson: " + json.firstChild.data + color.ENDC)
                           print(color.OKBLUE + "\tTier: " + tier.firstChild.data + color.ENDC)
