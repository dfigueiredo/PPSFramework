...
def getOptions():
    ...
    parser.add_option("-f", "--filename",
                  metavar="FILE", help="XML mapping file", default='grid_samples_2017_SD_elec.xml')
...
def execute(fromXML, crabsub, config):
     ...
     #try:
                for i in fromXML:
                                #(dataset, mode, era, year, json, tier, configfile, nevents, tagname)
                                crabsample = crabsub.doSubmit(i[0], i[1], i[2], i[3], i[4], i[5], i[6], i[7], i[8], i[9], i[10], config)
